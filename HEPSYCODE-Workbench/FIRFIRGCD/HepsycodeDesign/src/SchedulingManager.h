...
/*! \file SchedulingManager.h
    \brief HEPSIM Scheduling Manager Documented file.

    Scheduling Manager: Scheduling Manager file
*/

/** @defgroup scheduling_manager_group HEPSIM Scheduling Manager.
 *
 ...
 *  @date Apr. 2022
 *  @{
 */ // start scheduling_manager_group
...
/** @} */ // end of scheduling_manager_group
